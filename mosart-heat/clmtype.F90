...
type, public :: gridcell_wflux_type
   ...
   ! added by Hongyi Li
   real(r8), pointer :: qflx_qsurfg(:)       ! total grid-level surface liq runoff
   real(r8), pointer :: qflx_qdraig(:)       ! total grid-level subsurface liq runoff
end type gridcell_wflux_type

!----------------------------------------------------
! gridcell heat flux variables structure
!----------------------------------------------------
! gulu
type, public :: gridcell_hflux_type
   type(column_wflux_type):: chf_a           !column-level heat flux variables averaged to gridcell
...
type, public :: gridcell_type
   ...
   type(gridcell_hflux_type) :: ghf     !average of heat states/fluxes all landunits
